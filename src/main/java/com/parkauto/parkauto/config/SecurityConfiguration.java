...
@Bean
    public AuthenticationProvider authenticationProvider() { //creer methode va fournir l'access pour se connecter
    DaoAuthenticationProvider authenticationProvider = new DaoAuthenticationProvider();
    authenticationProvider.setUserDetailsService(userService.userDetailsService());
    authenticationProvider.setPasswordEncoder(passwordEncoder()); //appeler le coder
    return authenticationProvider;

    }
    @Bean
    public PasswordEncoder passwordEncoder(){ //coder le mot de passe
